...
function placeXorO(squareNumber) {
    ...
    function computersTurn() {
        ...
        let success = false;
        //this varaible stores a random number 0-8//
        let pickASquare;
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //temporary y axis data to update in the animation loop//
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        c.lineWidth = 10;
        //this mehtod sets the color of our line//
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //this condition is similar to the one above, this is necessary for the 6 4 2 wind conditions//
