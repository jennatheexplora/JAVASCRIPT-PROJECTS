...
const Calculator = {
    ...
    Display_Value: '0',
    //this will hold the first operand for any expression, we set it null for now//
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        //this overwrites Display_Value if the current value is 0, otherwise adds onto it//
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //we are saying that if the Display_Value does not contain a decimal point we want to add it//
